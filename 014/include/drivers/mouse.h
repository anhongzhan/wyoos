...
namespace wyoos
{
    namespace drivers
    {
        ...
        public:
            ...
            virtual void OnMouseDown(wyoos::common::uint8_t);
            virtual void OnMouseUp(wyoos::common::uint8_t);
            virtual void OnMouseMove(wyoos::common::int32_t x, wyoos::common::int32_t y);
        private:
