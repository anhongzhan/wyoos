...
amd_am79c973::amd_am79c973(PerippheraComponentInterconnectDeviceDescriptor *dev, InterruptManager* interrupts) 
    : Driver(), 
    InterruptHandler(dev->interrupt + interrupts->getHardwareInterruptOffset(), interrupts),
